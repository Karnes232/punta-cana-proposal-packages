...
export async function generateMetadata({
  ...
  let canonicalUrl;
  if (locale === "en") {
    canonicalUrl = `https://puntacanaproposalpackages.com/dining-proposals/${slug}`;
  } else {
    canonicalUrl = `https://puntacanaproposalpackages.com/es/dining-proposals/${slug}`;
  }
  ...
  return {
    ...
    alternates: {
      ...
      ...generateHreflangAlternates(locale, `/dining-proposals/${slug}`),
    },
  };
}
