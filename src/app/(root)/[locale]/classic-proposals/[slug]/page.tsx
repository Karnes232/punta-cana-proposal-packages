...
export async function generateMetadata({
  ...
  let canonicalUrl;
  if (locale === "en") {
    canonicalUrl = `https://puntacanaproposalpackages.com/classic-proposals/${slug}`;
  } else {
    canonicalUrl = `https://puntacanaproposalpackages.com/es/classic-proposals/${slug}`;
  }
  ...
  return {
    ...
    alternates: {
      ...
      ...generateHreflangAlternates(locale, `/classic-proposals/${slug}`),
    },
  };
}
