...
export default async function ModernProposalsSlug({ params }: { params: Promise<{ locale: string; slug: string }> }) {
 ...
 const t = await getTranslations("PackagePage.PackageHero");
  return (
    ...
    <PackageHero
      ...
      breadcrumbs={[{ label: t("modernProposals"), href: "/modern-proposals" }]}
