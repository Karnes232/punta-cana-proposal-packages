...
import type { StoryHeroImage } from "./types";
...
export default function StoryHeroBackground({
  photo,
  names,
}: StoryHeroBackgroundProps) {
  return (
    <>
      {/* Couple photo — full visibility, no opacity reduction */}
      {photo && (
        <Image
          src={photo.asset.url}
