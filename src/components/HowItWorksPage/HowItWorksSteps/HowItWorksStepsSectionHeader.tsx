interface HowItWorksStepsSectionHeaderProps {
    eyebrow: string;
    heading: string;
  ...
  export default function HowItWorksStepsSectionHeader({
    eyebrow,
    heading,
    headingAccent,
    subheading,
  }: HowItWorksStepsSectionHeaderProps) {
    return (
      <div className="flex flex-col items-center gap-4 text-center mb-20">
        ...
        >
          {heading}{" "}
          <em className="not-italic text-gold">{headingAccent}</em>
        </h2>
        ...
        {/* Subheading */}
        <p className="font-body font-light text-gray text-[clamp(14px,1.4vw,16px)] leading-relaxed max-w-lg">
          {subheading}
        </p>
      </div>
    );
