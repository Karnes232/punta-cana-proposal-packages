    ...
    items: [
      {
        ...
        title: "100% Private",
        caption:
          "Your moment is yours alone — no other guests, no interruptions.",
      },
      {
        id: "team",
        title: "Professional Team",
        caption:
          "Experienced coordinators on the ground every step of the way.",
      },
      {
        id: "inclusive",
    ...
    items: [
      {
        ...
        title: "100% Privado",
        caption:
          "Tu momento es solo tuyo — sin otros huéspedes ni interrupciones.",
      },
      {
        id: "team",
