        ...
        defineField({
          ...
          fields: [
            defineField({
              ...
              title: "Meta Title",
              type: "string",
              initialValue: "Punta Cana Proposal Packages",
              description:
        ...
        defineField({
          ...
          fields: [
            defineField({
              ...
              title: "Meta Title",
              type: "string",
              initialValue: "Paquetes de propuestas privados en Punta Cana",
              description:
            ...
            defineField({
              ...
              rows: 3,
              initialValue:
                "Experiencias de propuestas privadas en el corazón de Punta Cana.",
              description:
